...
class Ship: # class used to represent ships
    ...
    def __init__(self, length, start_row, start_col, vert):  # constructor for ship - takes ship length, start row and col, and vertical bool
    ...
    '''
    def _populate_indices(self, length, start_row, start_col, vert): # Add the indices a ship takes up to a set.
        if vert: # if vertical
    ...
    '''
    def _is_overlapping(self, otherShip): # Check if a ship overlaps another ship.
    ...
    def __repr__(self): # magic method to help with printing
